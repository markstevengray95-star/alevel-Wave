(()=>{
  ...
  function loadDetailUpgrades(){
    ...
    addCss("studio-3d-v18.css?v=18","studio3DV18Css");
    ...
    load("studio-3d-v18.js?v=18","studio3DV18Script");
  }
