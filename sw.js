const CACHE="waves-lab-v5";
const ASSETS=[
  "./","./index.html","./styles.css","./advanced-features.css","./detail-upgrades.css","./course-upgrades-v3.css","./waves-data.js","./textbook-data.js","./app.js","./textbook.js","./advanced-features.js","./integration-patches.js","./textbook-expansion.js","./simulation-upgrades-v2.js","./simulation-upgrades-v3.js","./textbook-interactives-v3.js","./question-engine-v3.js","./physics-icon.svg","./manifest.webmanifest"
];
