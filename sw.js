const CACHE="waves-lab-v3";
const ASSETS=[
  "./","./index.html","./styles.css","./advanced-features.css","./waves-data.js","./textbook-data.js","./app.js","./textbook.js","./advanced-features.js","./integration-patches.js","./physics-icon.svg","./manifest.webmanifest"
];
